terraform-provider-proxmox [![Build Status](https://travis-ci.org/chavalc/terraform-provider-proxmox.svg?branch=master)](https://travis-ci.org/chavalc/terraform-provider-proxmox)
==========================
